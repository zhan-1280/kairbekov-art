                            ...
                            <div class="col-md-6 p-3 text-black cart__right">
                                ...
                                <div class="quantity">
                                    ...
                                    <div class="d-flex quantity_buttons text24px weight700">
                                        ...
                                        <a href="/add-on-cart/<?php echo e($cart->product_id); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost-saukele\laravel\resources\views/cart.blade.php ENDPATH**/ ?>