                    ...
                    <div class="collapse navbar-collapse navbarSupportedContentTwo w-100" id="navbarSupportedContent">
                        <div class="navbar-nav navbar-mobile w-100">
                            <div class="navbar-nav navbar-mobile-nav d-flex justify-content-around">
                                <div class="nav-item">
                                    <a class="nav-link text-black" href="<?php echo e(url('/')); ?>">Главная</a>
                                </div>
                                <div class="nav-item">
                                    <a class="nav-link text-black" href="<?php echo e(url('/admin')); ?>">Администратор</a>
                                </div>
                                <div class="nav-item">
                                    <a class="nav-link text-white mobile-text-black" href="<?php echo e(url('/admin/orders')); ?>">Заказы</a>
                                </div>
                                <div class="nav-item">
                                    <a class="nav-link text-white mobile-text-black" href="<?php echo e(url('/admin/products')); ?>">Товары</a>
                                </div>
                                <div class="nav-item">
                                    <a class="nav-link text-white mobile-text-black" href="<?php echo e(url('/admin/category')); ?>">Категории</a>
                                </div>
                            </div>
...
<?php /**PATH C:\OpenServer\domains\localhost-saukele\laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>