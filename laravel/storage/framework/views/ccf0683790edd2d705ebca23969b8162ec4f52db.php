                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="remember" id="remember" <?php echo e(old('rules') ? 'checked' : ''); ?> required>

                                    <label class="form-check-label" for="remember">
                                        <?php echo e(__('Согласие на обработку персональных данных')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost-saukele\laravel\resources\views/auth/register.blade.php ENDPATH**/ ?>