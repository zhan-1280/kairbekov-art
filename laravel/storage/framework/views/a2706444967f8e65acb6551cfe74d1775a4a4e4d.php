                    ...
                    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="d-flex justify-content-between w-100 mb-3 cart__tr_body">
                            <td class="w-33 d-flex justify-content-start align-center"><img
                                    src="/img/<?php echo e($cart->product->image); ?>" alt="product-photo" class="cart-img">
                            </td>
                            <td class="w-33 d-flex justify-content-center align-center">
                                <strong><?php echo e($cart->Product->name); ?></strong>
                            </td>
                            <td class="w-33 d-flex justify-content-center align-center">
                                <a href="/remove-from-card/<?php echo e($cart->product_id); ?>"
                                    class="btn btn-primary m-auto">-</a>
                                <?php echo e($cart->quantity); ?>шт
                                <a href="/add-on-cart/<?php echo e($cart->product_id); ?>" class="btn btn-primary m-auto">+</a>
                            </td>
                            ...
                            <td class="w-33 d-flex justify-content-start align-center w-100 ps-4">
                                <div class="w-100">
                                    ...
                                    <div class="d-flex mb-3 justify-content-start w-70">
                                        ...
                                        <a href="/add-on-cart/<?php echo e($cart->product_id); ?>" class="btn btn-primary">+</a>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\localhost\laravel\resources\views/cart.blade.php ENDPATH**/ ?>